...
class Product(models.Model):
    ...
    stock_count = models.IntegerField(help_text="How many items are currently on stock")    # <input type='number'>
    price = models.DecimalField(max_digits=6, decimal_places=2)     # <input type='number'>
    description = models.TextField(null=True, blank=True)   # <textarea></textarea>
